    ...
    <div class="custom-page-header">
      ...
      <div class="header-actions">
        <div class="header-glass-card" style="padding: 10px 15px; border-radius: 8px; background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2);">
          ...
          <span id="lblNomeCandidatoHeader" style="color: #fff; font-weight: 600; font-size: 14px;">
            Bem-vindo(a)
          </span>
        </div>
      </div>
        ...
        <form name="formCandidato_${instanceId}" id="formCandidato_${instanceId}" role="form">
          <div data-step-content="1" class="step-content active">
            <h3 class="section-title">
              <i class="fa-solid fa-file-contract" style="color: rgb(177, 151, 252);">
              </i>
              LGPD, Carta Proposta e Manifesto de Assinatura
            </h3>
            <div class="document-grid primeiro-link-grid" id="primeiro_link_cards_${instanceId}">
              <div class="grid-card primeiro-link-card" data-doc-type="proposta">
                ...
                <div class="doc-status-badge" id="card_status_proposta_${instanceId}">
                  Ver arquivo
                </div>
              </div>
              <div class="grid-card primeiro-link-card" data-doc-type="lgpd">
                ...
                <div class="doc-status-badge" id="card_status_lgpd_${instanceId}">
                  Ver arquivo
                </div>
              </div>
              <div class="grid-card primeiro-link-card manifesto-card locked" data-doc-type="manifesto">
                ...
                <div class="doc-status-badge" id="card_status_manifesto_${instanceId}">
            ...
            <div class="text-center mt-20">
              <button type="button" class="btn btn-success btn-lg" id="btn_gerar_assinar_primeiro_link_${instanceId}" style="display: none;">
                ...
                Li e Aceito - Assinar Carta Proposta e LGPD
              </button>
            ...
            <div id="container_manifesto_tmpl_${instanceId}" style="position:absolute; left:-9999px; top:-9999px; width:800px; background:#fff; padding:32px;">
              <div style="border:1px solid #e5e7eb; border-radius:12px; padding:28px;">
                <h2 style="margin-top:0; color:#2f2f2f;">
                  Manifesto de Assinatura
                </h2>
                <p style="margin-bottom:8px;">
                  ...
                  <span id="manifesto_nome_${instanceId}">
                  </span>
                </p>
                <p style="margin-bottom:8px;">
                  <strong>
                  ...
                  <span id="manifesto_cpf_${instanceId}">
                  </span>
                </p>
                <p style="margin-bottom:8px;">
                  <strong>
                ...
                <p style="margin-bottom:8px;">
                  ...
                  Assinados e liberados para continuidade do fluxo.
                </p>
          ...
          <div data-step-content="2" class="step-content">
            ...
            <ul class="nav nav-tabs" role="tablist" id="tabMenuDados_${instanceId}">
              ...
              <li role="presentation">
                <a href="#tab_endereco_${instanceId}" aria-controls="tab_endereco_${instanceId}" role="tab" data-toggle="tab">
                  Endereço
                </a>
              </li>
              <li role="presentation">
              ...
              <li role="presentation">
                <a href="#tab_bancarios_${instanceId}" aria-controls="tab_bancarios_${instanceId}" role="tab" data-toggle="tab">
                  Bancários
                </a>
              </li>
              <li role="presentation">
                <a href="#tab_emergencia_${instanceId}" aria-controls="tab_emergencia_${instanceId}" role="tab" data-toggle="tab">
                  Emergência
                </a>
              </li>
              <li role="presentation">
                <a href="#tab_outros_docs_${instanceId}" aria-controls="tab_outros_docs_${instanceId}" role="tab" data-toggle="tab">
                  Docs Extras
                </a>
              </li>
              <li role="presentation">
                <a href="#tab_foto_${instanceId}" aria-controls="tab_foto_${instanceId}" role="tab" data-toggle="tab">
                  Foto
                </a>
              </li>
            </ul>
            <div class="tab-content shadow-panel" id="tabContentDados_${instanceId}">
              ...
              <div role="tabpanel" class="tab-pane" id="tab_bancarios_${instanceId}">
                ...
                <div id="div_alerta_abertura_conta_${instanceId}" style="display:none;" class="alert alert-warning small alerta-abertura-conta">
                  ...
                  <br>
                  <br>
                  <span class="texto-provisorio-abertura-conta">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <select class="form-control" id="cand_reservista_situacao_${instanceId}">
                            ...
                            <option value="Nao se aplica">
                              Não se aplica
                            </option>
                            <option value="Alistado">
                              Alistado
                            </option>
...
<input type="text" class="form-control" id="cand_cartao_sus_${instanceId}">
              ...
              <div role="tabpanel" class="tab-pane" id="tab_foto_${instanceId}">
                <div class="foto-step-shell">
                  <div class="foto-step-hero text-center">
                    <div class="foto-step-title">
                      Adicione uma foto para continuar
                    </div>
                    <div class="foto-step-subtitle">
                      Escolha entre tirar agora ou enviar uma imagem salva no seu dispositivo.
                    </div>
                  ...
                  <div class="foto-step-actions">
                    <button type="button" class="foto-action-card" id="btn_abrir_camera_${instanceId}">
                      ...
                      <span class="foto-action-title">
                        Tirar foto
                      </span>
                      <span class="foto-action-desc">
                        Abra a câmera e capture a imagem na hora.
                      </span>
                    </button>
                    <button type="button" class="foto-action-card" data-trigger-upload="file_cand_foto_${instanceId}">
                      ...
                      <span class="foto-action-desc">
                        Selecione uma foto já salva no aparelho.
                      </span>
                    </button>
                  </div>
                  <div class="foto-step-footer text-center">
                    <span class="text-muted">
                      A foto fica registrada no cadastro assim que for confirmada.
                    </span>
                  </div>
                    ...
                    <div class="custom-modal-dialog foto-camera-dialog">
                      <div class="custom-modal-content foto-camera-content">
                        <div class="custom-modal-header">
                          <h4 class="custom-modal-title" id="modalFotoTitle_${instanceId}">
                            Tirar foto
                          </h4>
                        ...
                        <div class="foto-camera-body">
                          <div class="foto-camera-stage foto-camera-live-stage" id="foto_camera_stage_live_${instanceId}">
                            ...
                            <div class="foto-camera-hint">
                              Posicione o rosto no centro e toque em Capturar foto.
                            </div>
                          </div>
                          <div class="foto-camera-stage foto-camera-preview-stage" id="foto_camera_stage_preview_${instanceId}" style="display:none;">
                            ...
                            <div class="foto-camera-hint">
                              Confira a imagem antes de confirmar o envio.
                            </div>
                          </div>
                        </div>
          ...
          <div id="customModalDocumento_${instanceId}" class="custom-modal-overlay" style="display:none;">
            <div class="custom-modal-dialog">
              <div class="custom-modal-content">
                <div class="custom-modal-header">
                  <h4 class="custom-modal-title" id="modalDocTitle_${instanceId}">
                    Documento
                  </h4>
                ...
                <div class="custom-modal-body" style="display:flex; flex-direction:row; align-items:stretch; overflow:hidden; background:#fff; min-height:78vh;">
                  <div class="viewer-sidebar" style="width:320px; min-width:320px; background:#273444; color:#e5eef7; display:flex; flex-direction:column;">
                    ...
                    <div class="sidebar-content" style="padding:18px;">
                      <div class="sidebar-section-title" style="text-transform:uppercase; font-size:11px; letter-spacing:1px; color:#9fb2c7; margin:0 0 10px 0; font-weight:700;">
                        Candidato
                      </div>
                      <div class="candidato-info-block" style="margin-bottom:18px; background:rgba(255,255,255,0.06); border-radius:8px; padding:14px;">
                        <p>
                          ...
                          <span id="modalDocNome_${instanceId}">
                            ...
                          </span>
                        </p>
                        <p>
                          ...
                          <span id="modalDocCpf_${instanceId}">
                            ...
                          </span>
                        </p>
                      </div>
                      ...
                      <div class="candidato-info-block" style="margin-bottom:18px; background:rgba(255,255,255,0.06); border-radius:8px; padding:14px;">
                        <p>
                          ...
                          <span id="modalDocTipo_${instanceId}">
                            ...
                          </span>
                        </p>
                        <p>
                          ...
                          <span id="modalDocStatus_${instanceId}">
                            ...
                          </span>
                        </p>
                      </div>
                      ...
                      <div class="candidato-info-block" style="margin-bottom:18px; background:rgba(255,255,255,0.06); border-radius:8px; padding:14px;">
                        <p>
                          Use o painel principal para ler o PDF. Feche e reabra quantas vezes precisar.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div data-step-content="3" class="step-content">
            ...
            <div class="row">
              <div class="form-group col-md-6">
                <label for="cand_grau_instrucao_${instanceId}">
                  Grau de Instrução
                </label>
                <select class="form-control" id="cand_grau_instrucao_${instanceId}" name="cand_grau_instrucao">
                  ...
                  <option value="Do 6º ao 9º ano do ensino fundamental">
                  ...
                  <option value="Educação superior incompleto">
                    Educação superior incompleto
                  </option>
                  <option value="Educação superior completo">
                    Educação superior completo
                  </option>
                  <option value="Pós Grad. incompleto">
                    Pós Grad. incompleto
                  </option>
                  <option value="Pós Grad. completo">
                    Pós Grad. completo
                  </option>
                  ...
                  <option value="Pós Dout. incompleto">
                    Pós Dout. incompleto
                  </option>
                  <option value="Pós Dout. completo">
                    Pós Dout. completo
                  </option>
                </select>
              </div>
              <div class="form-group col-md-6">
                <label for="cand_ano_conclusao_${instanceId}">
                  Ano de Conclusão
                </label>
            ...
            <div class="row">
              <div class="form-group col-md-6">
                <label for="cand_coordenador_nome_${instanceId}">
                  Nome do Coordenador (Curso/Estágio)
                </label>
                <input type="text" class="form-control" id="cand_coordenador_nome_${instanceId}">
              </div>
              <div class="form-group col-md-6">
                <label for="cand_coordenador_nacionalidade_${instanceId}">
                  Nacionalidade do Coordenador
                </label>
          ...
          <div data-step-content="4" class="step-content">
            ...
            <div class="alert alert-info">
              ...
              <strong>
                O cadastro da Mãe é obrigatório
              </strong>
              para o eSocial, mesmo que não seja dependente financeiro.
            </div>
            <div id="container_dependentes_${instanceId}">
              <div class="dependente-card" data-uuid="mae_fixa">
...
<option value="Sim">
          ...
          <div data-step-content="5" class="step-content">
            ...
            <div class="alert alert-info" id="alerta_filiacao_${instanceId}">
              <i class="flaticon flaticon-info">
              </i>
              Os dados de filiação são exibidos automaticamente com base nos dependentes cadastrados na etapa anterior.
            </div>
            <h4 style="color: #1eaad9; border-bottom: 1px solid #eee; padding-bottom: 5px;">
              Dados da Mãe
            </h4>
            <div class="row">
              <div class="form-group col-md-5">
            ...
            <h4 style="color: #1eaad9; border-bottom: 1px solid #eee; padding-bottom: 5px; margin-top: 20px;">
              Dados do Pai
            </h4>
            <div class="row">
              <div class="form-group col-md-5">
                ...
                <small class="text-muted">
                  Deixe em branco se não constar no registro.
                </small>
              </div>
              <div class="form-group col-md-3">
                <label>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="row">
                  <div class="form-group col-md-12">
                    <label>
                      Em relação ao vale transporte, escolha uma das opções:
                    </label>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="row">
                  <div class="form-group col-md-12">
                    <label>
                      Deseja incluir dependentes no plano de saúde?
                    </label>
                    <select class="form-control" id="cand_ps_opcao_${instanceId}">
                      <option value="" selected>
                        Selecione...
                      </option>
                      <option value="Opto pela inclusão de dependente(s) e estou ciente dos custos e regras">
                        Opto pela inclusão de dependente(s) e estou ciente dos custos e regras
                      </option>
                      <option value="Não opto pela inclusão de dependente(s)">
                        Não opto pela inclusão de dependente(s)
                      </option>
                    </select>
                  </div>
                </div>
                ...
                <div id="div_ps_detalhes_${instanceId}" style="display:none; background-color: #f9f9f9; padding: 15px; border: 1px solid #eee; border-radius: 4px; margin-bottom: 15px;">
                  <div class="row">
                    <div class="col-md-12">
                      <label>
                        Selecione os dependentes para inclusão:
                      </label>
                ...
                <div class="row" id="div_ps_custos_${instanceId}" style="display:none;">
                  <div class="col-md-12">
                    <div class="well well-sm" style="font-size: 12px; color: #8a6d3b; background-color: #fcf8e3; border-color: #faebcc; margin-bottom: 0;">
                      <strong>
                        Atenção aos custos mensais:
                      </strong>
                      <br>
                      <span id="texto_custo_plano_${instanceId}">
                        Calculando valor para sua filial...
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="row">
                  <div class="form-group col-md-12">
                    <label>
                      Deseja aderir ao Plano Odontológico?
                    </label>
                ...
                <div id="div_po_dependentes_${instanceId}" style="display:none; background-color: #f9f9f9; padding: 15px; border: 1px solid #eee; border-radius: 4px; margin-top: 15px;">
                  <div class="row">
                    <div class="col-md-12">
                      <label>
                        Selecione os dependentes para inclusão no Plano Odontológico:
                      </label>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="well well-sm" style="margin-bottom: 0;">
                      <span id="text_exame_orientacao_${instanceId}" class="text-info">
                        Consulte as orientações no e-mail recebido.
                      </span>
        ...
        <div class="row" style="display: flex; align-items: center; padding-bottom: 20px;">
          <div class="col-xs-4">
            <button type="button" class="btn btn-default " data-nav-back disabled>
              <i class="flaticon flaticon-arrow-left">
              </i>
              Voltar
            </button>
          </div>
          ...
          <div class="col-xs-4 text-right">
            ...
            <button type="button" class="btn btn-accept " data-finish style="display:none;">
              Finalizar e Enviar
              <i class="flaticon flaticon-send">
              </i>
            </button>
          </div>
        </div>
              ...
              <div class="col-md-4 doc-conjuge doc-cpf" style="display:none; margin-bottom: 25px;">
                <div class="upload-box text-center" style="padding: 15px; border: 2px dashed #bce8f1; border-radius: 6px; background-color: #f9fdfd; cursor: pointer; transition: all 0.3s ease;" onclick="$(this).siblings('input[type=\'file\']').trigger('click');">
                  ...
                  <h5 class="font-bold mt-10">
                    CPF
                    <span class="label label-warning" style="font-size:0.6em">
                      OCR
                    </span>
                  </h5>
                  <p class="text-muted small dep-file-status" style="overflow:hidden; white-space:nowrap; text-overflow:ellipsis;">
                    Anexar CPF
                  </p>
                  <button type="button" class="btn btn-default btn-xs dep-file-btn">
                    Anexar
                  </button>
                </div>
