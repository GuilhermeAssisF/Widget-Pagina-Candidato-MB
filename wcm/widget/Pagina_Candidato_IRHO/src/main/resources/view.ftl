        ...
        <div class="wizard-card">
            ...
            <form name="formCandidato_${instanceId}" id="formCandidato_${instanceId}" role="form">
                ...
                <div data-step-content="2" class="step-content">
                    <h3 class="section-title"><i class="flaticon flaticon-lock icon-sm"></i> Termo de Consentimento LGPD</h3>
                ...
                <div data-step-content="6" class="step-content">
                    <h3 class="section-title"><i class="flaticon flaticon-family icon-sm"></i> Filiação</h3>
                    ...
                    <div class="alert alert-info">
                        <i class="flaticon flaticon-info"></i> Preencha os dados dos seus pais. Caso já os tenha incluído como dependentes na etapa anterior, os dados serão carregados automaticamente.
                    </div>
                ...
                <div data-step-content="9" class="step-content">
                    <h3 class="section-title"><i class="flaticon flaticon-checked icon-sm"></i> Revisão e Envio</h3>
