...
<div class="main-content-card">
    ...
    <div id="form_main_container" class="container" style="max-width: 1000px; margin: 30px auto; padding: 0 15px;">
            ...
            <select class="form-control" id="cand_tamanho_calcado_${instanceId}">
                                            ...
                                            <option value="07">39</option><option value="08">40</option><option value="09">41</option>
                                            <option value="10">42</option><option value="11">43</option><option value="12">44</option>
            ...
            <select class="form-control" id="cand_tamanho_camisa_${instanceId}">
                                            ...
                                            <option value="07">XGG</option><option value="08">EGG</option><option value="09">GGG</option>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <h4 class="panel-title" style="margin-top: 5px; color: #8a6d3b;">
                                                    <i class="flaticon flaticon-person icon-sm"></i> Dados da Mãe (Obrigatório)
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
            ...
            <input type="text" class="form-control dep-obs" placeholder="Alguma observação?">
                    ...
                    <div data-step-content="5" class="step-content">
                        ...
                        <div class="alert alert-info" id="alerta_filiacao_${instanceId}">
                            <i class="flaticon flaticon-info"></i> Os dados de filiação são exibidos automaticamente com base nos dependentes cadastrados na etapa anterior.
                        </div>
            ...
            <select class="form-control" id="cand_vt_opcao_${instanceId}">
                                ...
                                <div id="div_vt_detalhes_${instanceId}" style="display: none; background-color: #f9f9f9; padding: 15px; border: 1px solid #eee; border-radius: 4px; margin-top: 10px;">
                                    <h5 class="text-info" style="margin-top:0;"><i class="flaticon flaticon-map-marker icon-sm"></i> Detalhes das Rotas de Transporte</h5>
                                    
                                    <div id="container_rotas_vt_${instanceId}"></div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading font-bold"><i class="flaticon flaticon-medical icon-sm"></i> Plano de Saúde</div>
                            <div class="panel-body">
                                
                                <div class="alert alert-info" style="font-size: 12px;">
                                    <strong>Informações sobre o Plano de Saúde:</strong><br>
                                    &bull; Plano disponível para colaboradores CLT.<br>
                                    &bull; Mensalidade do titular paga integralmente pela empresa.<br>
                                    &bull; Coparticipação (consultas e exames) por conta do colaborador.<br>
                                    &bull; Inclusão de dependentes é opcional, com custo integral (mensalidade + coparticipação) do colaborador.<br>
                               ...
                               <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12" id="div_ps_planos_${instanceId}" style="display:none;">
                                        <label for="cand_ps_tipo_plano_${instanceId}">Selecione o Plano de Saúde <span class="text-danger">*</span></label>
                                        <select class="form-control" id="cand_ps_tipo_plano_${instanceId}" name="cand_ps_tipo_plano_${instanceId}">
                                            <option value="">Selecione o plano</option>
                                            <option value="1">SulAmérica Especial 100</option>
                                ...
                                <div id="div_ps_detalhes_${instanceId}" style="display:none; background-color: #f9f9f9; padding: 15px; border: 1px solid #eee; border-radius: 4px; margin-bottom: 15px;">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div id="container_dependentes_plano_${instanceId}" style="margin-bottom: 10px;"></div>

                                            <div id="msg_elegibilidade_plano_${instanceId}" class="alert alert-warning" style="display: none; margin-bottom: 0; font-size: 12px;">
                                                <i class="flaticon flaticon-info icon-sm"></i> Apenas <strong>Cônjuges</strong> e <strong>Filhos</strong> podem ser incluídos no plano de saúde. Não identificamos dependentes com este parentesco cadastrados na etapa de "Dependentes".
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row" id="div_ps_custos_${instanceId}" style="display:none;">
                                    <div class="col-md-12">
                                        <div class="well well-sm" style="font-size: 12px; color: #8a6d3b; background-color: #fcf8e3; border-color: #faebcc; margin-bottom: 0;">
                                            <strong>Atenção aos custos mensais:</strong><br>
            ...
            <select class="form-control" id="cand_po_tipo_plano_${instanceId}">
                                ...
                                <div id="div_po_dependentes_${instanceId}" style="display:none; background-color: #f9f9f9; padding: 15px; border: 1px solid #eee; border-radius: 4px; margin-top: 15px;">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div id="container_dependentes_odonto_${instanceId}" style="margin-bottom: 10px;"></div>
                                            ...
                                            <div id="msg_elegibilidade_odonto_${instanceId}" class="alert alert-warning" style="display: none; margin-bottom: 0; font-size: 12px;">
                                                ...
                                                <strong>Atenção:</strong> Não identificamos dependentes elegíveis cadastrados na etapa de "Dependentes".
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div data-step-content="8" class="step-content">
                        ...
                        <div id="resumo_container_${instanceId}" style="margin-bottom: 30px;">
                            <p class="text-center text-muted"><i class="flaticon flaticon-refresh is-spinning"></i> Carregando resumo...</p>
                        </div>
                        ...
                        <div class="panel panel-info" style="border-color: #bce8f1;">
                            <div class="panel-heading" style="background-color: #d9edf7; color: #31708f; border-color: #bce8f1;">
                                <i class="flaticon flaticon-medical"></i> <strong>Agendamento do Exame Admissional</strong>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="cand_exame_endereco_${instanceId}" readonly style="background-color: #fff; font-weight:bold;">
                        ...
                        <div class="alert alert-success text-center" style="margin-top: 30px; padding: 20px;">
                            <i class="flaticon flaticon-check-circle icon-xl"></i><br>
                            <h4 style="margin-top: 10px;">Tudo Pronto!</h4>
                            <p>Confira os dados acima. Se estiver tudo correto, clique em <strong>"Finalizar e Enviar"</strong> abaixo.</p>
                        </div>
                    </div>
                </form>
        ...
        <script type="text/template" class="template-dependente">
            ...
            <input type="text" class="form-control fluig-calendar dep-nasc" placeholder="DD/MM/AAAA">
                        ...
                        <div class="row div-docs-dependente" style="display: none; margin-top: 20px; border-top: 1px dashed #ccc; padding-top: 20px;">
                                <div class="col-md-12"><h4 class="text-info mb-15"><i class="flaticon flaticon-file-check icon-sm"></i> Documentos do Dependente</h4></div>
                                ...
                                <div class="col-md-4 doc-conjuge doc-cpf" style="display:none; margin-bottom: 25px;">
                                    <div class="upload-box text-center" style="padding: 15px; border: 2px dashed #bce8f1; border-radius: 6px; background-color: #f9fdfd; cursor: pointer; transition: all 0.3s ease;" onclick="$(this).siblings('input[type=\'file\']').trigger('click');">
                                        <i class="flaticon flaticon-person icon-xl text-info"></i>
                                        <h5 class="font-bold mt-10">CPF <span class="label label-warning" style="font-size:0.6em">OCR</span></h5>
                                ...
                                <div class="col-md-4 doc-conjuge doc-rg-frente" style="display:none; margin-bottom: 25px;">
                                    <div class="upload-box text-center" style="padding: 15px; border: 2px dashed #bce8f1; border-radius: 6px; background-color: #f9fdfd; cursor: pointer; transition: all 0.3s ease;" onclick="$(this).siblings('input[type=\'file\']').trigger('click');">
                                        ...
                                        <h5 class="font-bold mt-10">RG Frente<span class="label label-warning" style="font-size:0.6em">OCR</span></h5>
                                ...
                                <div class="col-md-4 doc-conjuge doc-rg-verso" style="display:none; margin-bottom: 25px;">
                                    <div class="upload-box text-center" style="padding: 15px; border: 2px dashed #bce8f1; border-radius: 6px; background-color: #f9fdfd; cursor: pointer; transition: all 0.3s ease;" onclick="$(this).siblings('input[type=\'file\']').trigger('click');">
                                        <i class="flaticon flaticon-assignment-ind icon-xl text-info"></i>
                                        <h5 class="font-bold mt-10">RG Verso<span class="label label-warning" style="font-size:0.6em">OCR</span></h5>
                                ...
                                <div class="col-md-4 doc-filho doc-cert-nasc" style="display:none; margin-bottom: 25px;">
                                    <div class="upload-box text-center" style="padding: 15px; border: 2px dashed #bce8f1; border-radius: 6px; background-color: #f9fdfd; cursor: pointer; transition: all 0.3s ease;" onclick="$(this).siblings('input[type=\'file\']').trigger('click');">
                                        <i class="flaticon flaticon-file-check icon-xl text-info"></i>
                                        <h5 class="font-bold mt-10">Cert. Nascimento<span class="label label-warning" style="font-size:0.6em">OCR</span></h5>
